...
# WiFi
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/wifi/Diag_FW.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/Diag_FW.cfg \
    $(LOCAL_PATH)/configs/wifi/Diag_host.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/Diag_host.cfg \
